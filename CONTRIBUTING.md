...
Note that a standard [MIT](./LICENSE) is used license on this repo.

## Questions?

The easiest way to get attention is to comment on an existing, or open a new
[issue][].

[issue]: https://github.com/smusali/adapt-scraper/issues
